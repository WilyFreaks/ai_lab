...
print("- Immediate R5->R7 gap keys: telemetry#cnc_interface_counter_json#immediate_gap_out_key / ...#immediate_gap_in_key / ...#immediate_gap_pct")
print("- ThousandEyes response-time recovery keys: thousandeyes#cisco:thousandeyes:metric#response_time_ms.back_to_baseline_start_minutes + ...back_to_baseline_ramp_minutes")
