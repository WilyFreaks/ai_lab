...
print("- Saved-search description coverage: ALL 32 current saved searches in ai_lab have a description = key (capability first, use case examples at the bottom). Agents can rely on description = being present. Parameterized search: cnc_interface_ifInPktsRate_for_a_router requires router= arg (e.g. router=R2).")
