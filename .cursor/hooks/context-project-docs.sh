...
print("- Scenario 1 telemetry reroute keys: telemetry#cnc_interface_counter_json#reroute_from_slice / ...#reroute_to_slice / ...#reroute_pct / ...#reroute_start_minutes / ...#reroute_ramp_minutes")
...
print("- Scenario 1 immediate R5->R7 gap keys: telemetry#cnc_interface_counter_json#immediate_gap_out_key / ...#immediate_gap_in_key / ...#immediate_gap_pct")
print("- ThousandEyes response-time back-to-baseline keys: thousandeyes#cisco:thousandeyes:metric#response_time_ms.back_to_baseline_start_minutes / ...back_to_baseline_ramp_minutes")
