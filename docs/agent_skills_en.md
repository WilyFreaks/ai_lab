# 5G WDM Backbone Network Failure Detection & Root Cause Analysis
...
Finally, verify the ThousandEyes service monitor status from Step 1 again and confirm that the network service has successfully recovered after the SR-TE policy switchover.